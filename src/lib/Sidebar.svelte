...
import { Network, FileText, Route, ListTree, AlertTriangle, Box, Bug, Shield, List, Activity } from 'lucide-svelte';
	...
	const modelLinks = [
		{ name: "The Big Picture", href: "/bigpicture", icon: Activity },
