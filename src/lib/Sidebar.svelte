...
import { Network, FileText, Route, ListTree, AlertTriangle, Box, Bug, Shield, List, BarChart4 } from 'lucide-svelte';
	...
	const modelLinks = [
		{ name: "The Big Picture", href: "/bigpicture", icon: BarChart4 },
