-- Migration for PAT-169: Make assets a full-fledged part of risk story extraction
-- Update upsert_risk_model procedure to include Section 0: BULK UPSERT ASSETS
